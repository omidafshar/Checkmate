...
class UITextFieldX: UITextField {
    ...
    func setLeftImage() {
        ...
        if let image = leftImage {
            ...
            // Note: In order for an image to use the tint color, you have to select the image in the Assets.xcassets and change the "Render As" property to "Template Image".
